...
var Person = function () {
  function Person() {
    var name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'None Sense';
...
var me = new Student('Alejandro Espitia', 25, 'IT');
console.log(me.getGreeting());
console.log(me.hasMajor());
console.log(me.getDescription());

var trave = new Traveler('Andrew Mead', 36, 'Phillie');
console.log(trave.getGreeting());

var trave_sec = new Traveler('Charles', 20);
